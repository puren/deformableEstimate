...
void Deformable::clusterVertex()
{
    ...
    if (params.m>=params.cluster_size(0)) {
        cluster_sizex=params.cluster_size(0);
    }
    if (params.n>=params.cluster_size(1)) {
        cluster_sizey=params.cluster_size(1);
    }
    if (params.p>=params.cluster_size(2)) {
        cluster_sizez=params.cluster_size(2);
    }
